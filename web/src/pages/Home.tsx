        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div>
            ...
            <ul className="mt-4 space-y-3 text-[15px] text-slate-400">
              ...
              <li><strong className="text-slate-200">Usable by an agent, not only a program.</strong> The same service is an <Link to="/agents" className="text-ember-400 hover:text-ember-300">MCP server</Link>, behind the same key and the same limits, returning summaries sized for a context window rather than megabytes of JSON.</li>
