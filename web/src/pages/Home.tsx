        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div>
            ...
            <ul className="mt-4 space-y-3 text-[15px] text-slate-400">
              ...
              <li><strong className="text-slate-200">An adaptive query planner.</strong> The store estimates how many rows an AOI will match and picks between an R-tree probe and a vectorised scan — 18× faster on large AOIs, identical results.</li>
